  ...
  return (
    <div className="min-w-0 w-full">
      ...
      <div className="mt-4 hidden rounded-3xl border border-slate-200 bg-white p-5 shadow-sm lg:block">
        <div className="flex items-center justify-between gap-3"><div className="min-w-0"><div className="text-xs font-bold uppercase tracking-wider text-slate-400">Баланс</div><h3 className="mt-1 text-lg font-bold">История операций</h3></div><Wallet size={20} className="shrink-0 text-[#0b6078]"/></div>
