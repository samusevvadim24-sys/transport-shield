                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      <div className="mb-1.5 flex flex-wrap items-center gap-1.5">{cust.number && <span className="inline-flex items-center rounded-md bg-slate-100 px-2 py-1 font-mono text-[10px] font-semibold text-slate-600">№{cust.number}</span>}{cust.type && <span className="rounded-md bg-[#042433]/5 px-2 py-1 text-[10px] font-medium text-[#042433]">{cust.type}</span>}</div>
